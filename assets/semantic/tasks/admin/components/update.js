...
var
  ...
  // str_lctr_admin files
  github         = require('../../config/str_lctr_admin/github.js'),
  release        = require('../../config/str_lctr_admin/release'),
  project        = require('../../config/project/release'),


  // oAuth configuration for GitHub
  oAuth          = fs.existsSync(__dirname + '/../../config/str_lctr_admin/oauth.js')
    ? require('../../config/str_lctr_admin/oauth')
    : false,
...
module.exports = function(callback) {
  ...
  if(!oAuth) {
    console.error('Must add oauth token for GitHub in tasks/config/str_lctr_admin/oauth.js');
    return;
  }
